...
<main id="main">
  ...
  <section class="tight">
    <div class="wrap">
      ...
      <div class="related reveal">
        <a href="/book.html" data-evt="solutions_leadgen_click"><strong>Lead Generation (by invitation)</strong><span>Offered by invitation to a few businesses, under their own agreement. A person here reads public pages and builds you a list of the businesses that need what you do, with the page each row came from and the day it was read. Each row is scored against what you told us you want, in words. You decide every row, and nobody on it is contacted by us.</span></a>
