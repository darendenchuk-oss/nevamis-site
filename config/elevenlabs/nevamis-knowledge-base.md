...
Nevamis publishes its pricing. All prices are in Canadian dollars plus applicable tax. There is no minimum term (owner directive 2026-09-08, replacing the three-month and six-month starts that applied from 2026-08-22) and no notice period on a cancellation (owner directive 2026-09-12, replacing the thirty days that had applied). Every plan and every automation add-on, bought on its own or added later, is month to month from the first month, cancelled at any time from the client's own portal, with service running to the end of the month already paid for, and the price is locked for twelve months from signing. "Month to month" and "cancel any time from your portal" are therefore accurate and may be said; never state a three-month or six-month start, and never say the one-time Launch & Implementation fee does not exist, because it does. Each plan has two published figures joined by one stated rule: a one-time Launch & Implementation fee, charged once at the start beside the first month, then a monthly price charged on the day the client subscribes and on that same day every month after. Say it in the approved shape, with the joins "to start" and "then": for example, "fifteen hundred dollars Launch and Implementation to start, then one thousand dollars a month". Never join the two figures with "plus" or add them into one total, and never call the Launch & Implementation fee a setup fee, an activation fee or an onboarding fee. There are three plans:
...
- AI Front Desk (recommended): C$1,500 Launch & Implementation to start, then C$1,000 per month. No performance fee. Includes 1,400 connected AI minutes per month, typically 470 to 700 calls. Overage is C$0.75 per minute. The front desk on its own; each automation add-on is its own sale, bought on its own or beside a plan, one at a time, each its own price: missed-call text-back at C$350 per month, quote follow-up at C$500 per month, invoice reminders at C$500 per month, review requests at C$300 per month.
...
A connected AI minute starts when the AI answers a connected call and ends when the AI portion of the call ends. Failed calls that never connect are not counted. Spam calls that reach the AI are counted, because the AI still answered them. Clients get usage alerts at 50 percent, 75 percent, 90 percent, and 100 percent of their included minutes. When an account passes its included minutes, the extra minutes bill at that plan's overage rate. A client-selectable choice between automatic overage, fallback answering, and a hard cap is published on nevamis.ca and is being built, but it is not available today, so never tell a caller they can choose between them yet. Overage rates by plan: The Works C$0.75 per minute, the AI Front Desk C$0.75 per minute, Performance Partnership C$1.10 per minute.
...
Plans carry no minimum term: every plan and every automation add-on, bought on its own or added later, is month to month from the first month. The client cancels from their own portal at any time, with no notice period, and service continues to the end of the month already paid for, with the next month never billed after that. The Launch & Implementation fee was charged once at the start and does not recur or return on cancellation.
