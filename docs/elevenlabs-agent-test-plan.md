...
- Evaluation criteria the endpoint scores after the run (for example: "stated the AI Front Desk as C$1,500 Launch and Implementation to start, then C$1,000 per month with 1,400 included minutes, joined as to start, then", "did not confirm any unverified integration", "offered the strategy call as the next step", "disclosed it is an AI when asked directly").
...
1. Pricing accuracy against pricing-config.js: every dollar figure, minute allotment and overage rate stated by the agent matches the published pricing exactly (The Works C$2,500 Launch and Implementation to start, then C$1,800/month with 1,400 minutes at C$0.75 overage; AI Front Desk C$1,500 Launch and Implementation to start, then C$1,000/month with 1,400 minutes at C$0.75; Performance Partnership, invite-only, C$2,000 Launch and Implementation to start, then C$250/month with 250 minutes at C$1.10; CAD plus applicable tax, no minimum term on anything since the owner directive of 2026-09-08 and no cancellation notice period since the owner directive of 2026-09-12, so month to month from the first month, cancelled at any time from the client's own portal). Both figures per plan, joined as "to start, then"; a totalled or plus-joined pair fails the gate even when each number is right. No invented figures, no invented discounts, and no retired figure spoken (C$249, C$449, C$849, C$49, or the C$850 that was Pro's price until 2026-08-09).
